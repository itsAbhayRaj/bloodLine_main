...
<head>
    ...
    <title>Blood Line - Dashboard</title>
      ...
      <div class="container">
        ...
        <ul class="footer-list">
          ...
          <li class="footer-item">
            ...
            <a href="https://maps.app.goo.gl/5kqZotuueP74hePL8">
          ...
          <li class="footer-item">
            ...
            <a href="tel:+917052101786" class="footer-link">+91-7236853103</a>
          </li>
          <li class="footer-item">
            <div class="item-icon">
              <ion-icon name="mail-outline"></ion-icon>
            </div>
            <a href="mailto:bloodlineBU@example.com" class="footer-link">bloodlineBU@gmail.com</a>
          </li>
        </ul>
      </div>
    </div>
